...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | AllOver ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
	<link rel="shortcut icon" type="image/x-icon" href="images/cover.png">
...
<body>
	<div id="logo" align="center"><img src="<?php echo base_url();?>/images/cover.png"></div>
		...
		<?php echo form_open('login') ?>
			<div id="container">
				...
				<div id="login_form">
					...
					<input class="btn btn-primary btn-block" type="submit" name="loginButton" value="Ir"/>
				</div>
			</div>
		<?php echo form_close(); ?>
