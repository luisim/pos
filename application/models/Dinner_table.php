...
class Dinner_table extends CI_Model
{
	...
	*/
	...
	public function get_employees()
	{
		...
		$empty_employees = $this->db->get()->result_array();

		$empty_employees_array = array();
		foreach($empty_employees as $empty_employee)
		{
			$empty_employees_array[$empty_employee['person_id']] = $empty_employee['username'];
		}

		return $empty_employees_array;
	}
